...
{},d=[],e=function(a,b,c){var d="^"+b.replace(/[\.\\\(\)\^\$]/g,"$1")+"$",e=[],f={};j(b.split(/\W/),function(a){if(a){var b=RegExp(":"+a+"([\\W])");d.match(b)&&(d=d.replace(b,"([^/]*)$1"),e.push(a))}});var g=a.match(RegExp(d));g&&(j(e,function(a,b){f[a]=g[b+1]}),c&&this.$set(c,f));return g?f:null},f=this,g=0,h,i,k={routes:c,onChangeListener:function(a){d.push(a);return a},parent:function(a){a&&(f=a)},when:function(a,b){if(t(a))return c;var d=c[a];d||(d=c[a]={reloadOnSearch:!0});b&&u(d,b);g++;return d},otherwise:function(a){k.when(null,
